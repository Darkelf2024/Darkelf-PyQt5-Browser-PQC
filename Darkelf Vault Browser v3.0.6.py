    ...
    def start_tor(self):
        try:
            ...
            bridges = [
                ...
                "obfs4 87.114.6.12:9877 E867187EE0B9D6F531395A41B5ECC4D5CD3BAB23 cert=EH1hAv/F7C51YMPJ6dqHFxgV2jjkbsbfCn2lndnXKXnSxYEJDkE5+058kdSXTh81RiiHBw iat-mode=0"
            ]
...
def main():
    ...
    # Start TLS monitor after 20s delay to allow Tor to fully bootstrap
